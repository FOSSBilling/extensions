...
// exceeded. Previous still reaches page 1 eventually - the empty-stack
// fallback below treats "no cursor" as page 1 either way - but once an
// entry has been evicted, walking all the way back silently skips the
// page(s) whose cursor was dropped rather than stopping on them. A bounded
// stack can't do better without either unbounded growth or tracking depth
// separately from the cursors themselves; skipping a page on a 22+-page
// walk-back is the smaller cost.
