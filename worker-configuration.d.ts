/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 78e125c5cc54a58271b2f1fe4f8fd158)
// Runtime types generated with workerd@1.20260801.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	EXTENSIONS_API_TRANSPORT: "binding";
	AUTH_CLIENT_ID: string;
	AUTH_CLIENT_SECRET: string;
	SESSION_SECRET: string;
	ASSERTION_SIGNING_SECRET: string;
	EXTENSIONS_API_BASE_URL: string;
	EXTENSIONS_API: Fetcher /* api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXTENSIONS_API_TRANSPORT" | "AUTH_CLIENT_ID" | "AUTH_CLIENT_SECRET" | "SESSION_SECRET" | "ASSERTION_SIGNING_SECRET" | "EXTENSIONS_API_BASE_URL">> {}
}
